// json같은 자료형 편집을 위해서 쓰는 lodash
import _ from "lodash";
// filesystem
import { registerDataQuery } from "../core/data/db.mysql.js";
...
// import { getContractProof, getContractAddr } from "../core/contracts/utils.js";
...
export const registDataController = async (req, res) => {
  ...
  // const contractVerifyInput =
  //   registDataInputJsonToContractFormat(verifySnarkFormat);
  ...
  if (await registerDataQuery(registerDataJson)) {
    try {
      return res.send({
        flag: true,
        // receipt: receipt,
